...
export default {
        ...
        if (this.paymentWidget) {
          ...
          await this.paymentWidget.requestPayment({
            ...
            orderName:
              ...
              this.info[0].hosu +
              "호",
            customerAddress: this.info[0].agent,
            // customerEmail: "customer123@gmail.com",
            // customerMobilePhone: "01012341234",
            successUrl: `${window.location.origin}/success/${this.$route.params.TokenId}/${this.$route.params.Hosu}`,
  ...
  async mounted() {
    ...
    this.paymentMethodWidget = this.paymentWidget.renderPaymentMethods(
      "#payment-method",
      { value: this.info[0].option[1] * 100 },
      { variantKey: "DEFAULT" }
    );
    // ------  이용약관 UI 렌더링 ------
